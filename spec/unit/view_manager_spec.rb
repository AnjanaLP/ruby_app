...
describe ViewManager do
  ...
  describe '#sort_views' do
    context 'when given no argument' do
      it 'returns an array of webpages with all their view count in descending view count order' do
    ...
    context 'when given :unique as an argument' do
      it 'returns an array of webpages with their unique view count' do
        ...
        expect(view_manager.sort_views(:unique)).to eq [["/help", 3]]
      end
    end
  end
end
